<!--
	============================================================================
	ملف: BrowseByTopic.svelte
	الوصف: مكون التصفح حسب الموضوع
	============================================================================
	
	هذا المكون يعرض شبكة من المواضيع الإسلامية
	كل موضوع يحتوي على أيقونة، عنوان، وصف، وعدد الأحاديث
	
	المميزات:
	- أيقونات SVG مخصصة لكل موضوع
...
<script lang="ts">
	...
	// كائن يحتوي على أيقونات SVG لكل موضوع
	// المفتاح: اسم الموضوع | القيمة: كود SVG
	const icons: Record<string, string> = {
		// أيقونة العبادات - نجمة مع دائرة
	...
	// مصفوفة المواضيع مع بياناتها
	const topics = [
		{ 
			icon: 'worship',           // مفتاح الأيقونة
			title: 'العبادات',         // عنوان الموضوع
			desc: 'الصلاة، الصيام، الزكاة',  // وصف مختصر
			count: 12847,              // عدد الأحاديث
			color: '#1B4D3E'           // لون الأيقونة
		},
		{ 
			icon: 'dealings', 
			title: 'المعاملات', 
			desc: 'البيع، الزواج، الميراث', 
			count: 8234, 
			color: '#2563eb' 
		},
		{ 
...
<!-- 
	قسم التصفح حسب الموضوع
	خلفية متدرجة من الرمادي للأبيض
-->
	...
	<div class="container">
		...
		<div class="text-center mb-14">
			...
			<p class="section-subtitle">
				استكشف الأحاديث النبوية مصنفة حسب مواضيع الحياة المختلفة
			</p>
		</div>
...
<style>
	...
	.topic-card:hover {
		transform: translateY(-6px);  /* رفع للأعلى */
	...
	.topic-icon {
		...
		color: var(--icon-color, #1B4D3E);  /* لون متغير */
	}
	...
	.topic-card:hover .topic-arrow {
		background: #1B4D3E;
		color: white;
		transform: translateX(4px);  /* تحريك لليسار */
	}
</style>
